...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/11/09 15:45:01 by loberyn           #+#    #+#             */
/*   Updated: 2020/11/12 19:02:02 by loberyn          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(int argc, char const *argv[])
{
	...
	to_check = ft_lstnew(strs[2]);
	print_list(to_check);
	ft_lstadd_back(list, to_check);
...
//    printf("All good\n");
	...
	printf("We cleared a list, list is:%p\n", &empty);
	printf("What about address of empty: %p\n", empty); 
	strs[0] = strdup("opppoppop");
    printf("Lets try again: %p\n", empty);
	ft_lstadd_back(&empty, ft_lstnew(strs[0]));
	printf("We added to the back\n");
